...
export const {
  ...
  useGetCountUsersAndDoctorStatsByMonthQuery,
  useGetCountReviewsAndOrdersStatsByMonthQuery,
  useGetPopularDoctorsQuery,
  useGetPercentageStatisticsQuery,
  useGetDoctorStatisticByMonthQuery,
  useGetAllDoctorStatisticQuery,
} = statisticsApi;
